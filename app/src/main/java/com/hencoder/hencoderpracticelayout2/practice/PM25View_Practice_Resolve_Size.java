...
public class PM25View_Practice_Resolve_Size extends PM25View {
    ...
    public PM25View_Practice_Resolve_Size(Context context) {
        super(context);
    }

    public PM25View_Practice_Resolve_Size(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PM25View_Practice_Resolve_Size(Context context, AttributeSet attrs, int defStyleAttr) {
